	...
	<br></br>
			<div class="three-clean-buttons">
				<div class="clean-button">
					<span class="text"><a href="studentlogin.jsp">学生登录</a></span>
				</div>
			</div>
			<br></br>
			<div class="three-clean-buttons">
				<div class="clean-button">
					<span class="text"><a href="studentapply.jsp">学生注册</a></span>
				</div>
			</div>
	<br></br>
			<div class="three-clean-buttons">
				<div class="clean-button">
					<span class="text"><a href="teacherlogin.jsp">导师登录</a></span>
				</div>
			</div>
		<br></br>
			<div class="three-clean-buttons">
				<div class="clean-button">
					<span class="text"><a href="teacherapply.jsp">导师注册</a></span>
				</div>
			</div>
